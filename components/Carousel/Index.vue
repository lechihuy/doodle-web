...
<template>
  <div class="relative w-full flex snap-x snap-mandatory overflow-x-auto">
    <div class="snap-center w-1/3 shrink-0">
      <div class="shrink-0"></div>
    </div>
    <div class="snap-center w-1/3 flex-none">
    ...
    <div class="snap-center w-1/3 flex-none">
      <img class="w-full" src="https://images.unsplash.com/photo-1559333086-b0a56225a93c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=320&h=160&q=80" />
    </div>
    <div class="snap-center w-1/3 shrink-0">
      <div class="shrink-0"></div>
    </div>
